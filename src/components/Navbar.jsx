      ...
      <AnimatePresence>
        {menu && (
          <motion.div
            ...
            exit={{ scale: 0 }}
            className="z-[77] h-full w-full fixed top-0 left-0 right-0 bottom-0 bg-black flex flex-col justify-center items-center  gap-y-[25px] [&>*]:text-[1.5rem] font-bold lg:hidden xl:hidden"
          >
            <i
